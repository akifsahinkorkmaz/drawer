  ...
  return (
    <div className='w-screen h-screen bg-gray-900 text-teal-50 p-4 lg:p-8 lg:flex lg:items-center lg:justify-between'>
      ...
      <div className='text-xl md:text-2xl text-left mt-4 mb-12 p-4 rounded bg-gray-600'>
        ...
        <p className='m-4'><strong className='text-amber-500'> 1.</strong> Visit <a className='text-amber-500' href="https://akifsahinkorkmaz.github.io/painter/">https://akifsahinkorkmaz.github.io/painter/</a> on a device that is preferably desktop</p>
        <p className='m-4'><strong className='text-amber-500'> 2.</strong> Select INPUT on that device </p>
